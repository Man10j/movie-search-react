...
const Preview = (props) => {
  ...
  return (
    <div>
      ...
      />
      <NavLink to="/wishlist">
        <BookmarkIcon id="wishlisticon" />
      </NavLink>
      <div className="preview_container">
        <div>
          <img
            src={values.movieposter}
            alt="movie_poster"
            className="movie_poster"
          />
        </div>
        <div>
          <span className="preview_data">Title :</span> {values.moviename}
        </div>
        <div>
          <span className="preview_data">ReleaseDate :</span>{" "}
          {values.movierelease}
        </div>
        <div>
          <span className="preview_data">Overview :</span>{" "}
          {values.movieoverview}
        </div>
      </div>
    </div>
  );
